...
(
	...
	constraint pk_CompraPlaza primary key(idCompra),
...
(
	...
	constraint pk_Importa primary key(idCompra),
	constraint fk_CompraPlaza foreign key(idCompra) references Compra(id)
...
(
	...
	constraint pk_Importa primary key(id, idPlanta),
	constraint fk_CompraPlaza foreign key(idPlanta) references Plantas(id)
...
(
	...
	constraint pk_FotoPlanta primary key(id, idPlanta),
